...
$(APP_BUNDLE_OUT): $(APP_BUNDLE_SRC) src/app-media-utils.mjs src/app-bible-reference-utils.mjs src/app-bible-scripture-render.mjs src/scripture-presentation-state.mjs src/lower-third-theme.mjs src/app-countdown.mjs src/app-pptx-utils.mjs src/app-controls-utils.mjs src/app-media-loading-utils.mjs src/app-toasts.mjs src/app-output-hold.mjs src/app-ui-templates.mjs src/app-song-utils.mjs src/app-slide-utils.mjs src/output-compositor.mjs src/output-roles.mjs src/global-navigation-state.mjs src/schemas/ems-slide.types.mjs Makefile | $(DERIVED_DIR)
ifeq ($(WINDOWS), 1)
	@powershell -NoProfile -c "New-Item -ItemType Directory -Force -Path '$(dir $@)'" >nul 2>&1
else
	@mkdir -p $(dir $@)
